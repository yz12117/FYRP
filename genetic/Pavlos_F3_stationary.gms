...
$set myroot InputForGAMS/Pavlos/F3/stationary/
$set condition stationary
$set feed F3
$set doc Pavlos
*$set doc SAR_FeedC
*$set doc SAR_FeedAll
...
*       offaeromethionine(j)       = set of reactions that should be turned off under aerobic methionine conditions
...
metObj.. methionine =e= v('Uptake7176');
...
Model MaxMet
/
Stoic Flux_Upper Flux_Lower metObj
/;
...
Model TestModel
/
Stoic bio Flux_Upper_t Flux_Lower_t Obj metObj
/;
...
solve MaxMet using lp minimizing methionine;
put 'Max Biomass = 'b.l:0:8/;
put 'Max IgG = 'z.l:0:8/;
put 'Min met uptake = 'methionine.l:0:8/;
maxb = b.l;
maxi = z.l;
minmet = 0.0033;
...
*                                       put 'v(GS) = 'z.l:0:8/;
                                        ...
                                        put 'Biomass is ='v.l('R5261 '):0:8/;
                                        put 'IgG flux is = 'v.l('R1082 '):0:8/;
                                        put 'met uptake flux is = 'methionine.l:0:8/;
