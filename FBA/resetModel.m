function [model,isDrain] = resetModel(model,exreac,bnd,rev,zeroRxns)
...
%               default = model.rev
%
%  exreac   =   any value to which you would like to set the
%               maximum/minimum bnds
%               default = 100
%  zeroRxns =   rxn IDs for which lb = ub = 0
%
% OUTPUTS
%
...
for i = 1:size(model.rxns)
    if rev(i,1) == 1 %% 0 for carinhas, 1 for everything else
